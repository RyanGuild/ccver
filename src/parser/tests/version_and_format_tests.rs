...
fn test_parsing() -> Result<()> {
    ...
    dbg!(cc_parse_format!(CCVER_VERSION_FORMAT, "vCC.CC.CC-rc.CC")?);
    dbg!(cc_parse_format!(CCVER_VERSION_FORMAT, "YY.MM.DD-test.SS")?);
    dbg!(cc_parse_format!(CCVER_VERSION_FORMAT, "YYYY.CC.CC-<sha>")?);
    dbg!(cc_parse_format!(
